  ...
  data () {
    return {
      ...
      indicatorList: [
        ...
        { isActive: false, id: '#Projects', title: 'Pengalaman PKL', linkId: '2' },
        { isActive: false, id: '#Somedia', title: 'Kantor WaliKota', linkId: '3' },
        {
          isActive: false,
          id: '#ContactManager',
          title: 'PT. Officia Sinergi',
          linkId: '4'
        },
        { isActive: false, id: '#MemoryGame', title: 'Kantor PT. Officia Sinergi', linkId: '5' },
        {
          isActive: false,
          id: '#TumblrcClone',
          title: 'Sekolah Saya',
